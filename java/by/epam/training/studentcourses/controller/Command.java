...
public interface Command {
	...
	public static final Service service = ServiceFactory.getInstance();
	
	String execute(HttpServletRequest request, HttpServletResponse response) throws ControllerException, IOException;
